...
```
git clone https://github.com/muhammadkmal27/Project-XSS-Linux---V2.git
cd Project-XSS-Linux/
```
...
How to use: 
```
paramspider -d https://www.example.com/page?key1=value1&key2=value2
```
(choose one of the URL parameters)
